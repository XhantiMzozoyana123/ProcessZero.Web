...
{
    public class AllowTimerServiceAttribute : Attribute, IAsyncAuthorizationFilter
    {
        ...
        public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
        {
            var logger = context.HttpContext.RequestServices
                .GetService(typeof(ILogger<AllowTimerServiceAttribute>)) as ILogger<AllowTimerServiceAttribute>;
