...
namespace ProcessZero.Domain.Migrations
{
    ...
    [Migration("20260704215948_AddSurveyTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProcessZero.Domain.Entities.ResearchAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ResearchContactId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ResearchContactId");

                    b.HasIndex("UserId", "ProductId", "SubmittedAt")
                        .IsDescending(false, false, true)
                        .HasDatabaseName("IX_ResearchAnswers_UserId_ProductId_SubmittedAt");

                    b.ToTable("ResearchAnswers");
                });

            modelBuilder.Entity("ProcessZero.Domain.Entities.ResearchContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Email")
                        .HasDatabaseName("IX_ResearchContacts_Email");

                    b.HasIndex("ProductId")
                        .HasDatabaseName("IX_ResearchContacts_ProductId");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_ResearchContacts_UserId");

                    b.ToTable("ResearchContacts");
                });

            modelBuilder.Entity("ProcessZero.Domain.Entities.ResearchQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProcessZero.Domain.Entities.ResearchAnswer", b =>
                {
                    b.HasOne("ProcessZero.Domain.Entities.ResearchContact", "Contact")
                        .WithMany()
                        .HasForeignKey("ResearchContactId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
