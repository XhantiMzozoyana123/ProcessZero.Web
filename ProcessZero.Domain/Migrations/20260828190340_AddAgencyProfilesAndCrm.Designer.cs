...
namespace ProcessZero.Web.ProcessZero.Domain.Migrations
{
    ...
    [Migration("20260828190340_AddAgencyProfilesAndCrm")]
    partial class AddAgencyProfilesAndCrm
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProcessZero.Domain.Entities.AgencyActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AgencyProfileId")
                        .HasDatabaseName("IX_AgencyActivities_AgencyProfileId");

                    b.HasIndex("ContactId");

                    b.HasIndex("DealId");

                    b.ToTable("AgencyActivities");
                });

            modelBuilder.Entity("ProcessZero.Domain.Entities.AgencyContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AgencyProfileId")
                        .HasDatabaseName("IX_AgencyContacts_AgencyProfileId");

                    b.ToTable("AgencyContacts");
                });

            modelBuilder.Entity("ProcessZero.Domain.Entities.AgencyDeal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AgencyProfileId", "Stage")
                        .HasDatabaseName("IX_AgencyDeals_Agency_Stage");

                    b.ToTable("AgencyDeals");
                });

            modelBuilder.Entity("ProcessZero.Domain.Entities.AgencyManager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_AgencyManagers_UserId");

                    b.HasIndex("AgencyProfileId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("IX_AgencyManagers_Agency_UserId");

                    b.ToTable("AgencyManagers");
                });

            modelBuilder.Entity("ProcessZero.Domain.Entities.AgencyProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LinkedUserId")
                        .IsUnique()
                        .HasDatabaseName("IX_AgencyProfiles_LinkedUserId");
            ...
            modelBuilder.Entity("ProcessZero.Domain.Entities.ConsumptionConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("EnforceAccessBlock")
                        .HasColumnType("tinyint(1)");

                    b.Property<int>("GracePeriodMinutes")
                        .HasColumnType("int");

                    b.Property<decimal>("InitialFreeHours")
                        .HasColumnType("decimal(65,30)");
            ...
            modelBuilder.Entity("ProcessZero.Domain.Entities.PaymentOrder", b =>
                {
                    ...
                    b.Property<string>("PayShapAccountHolder")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("varchar(256)");

                    b.Property<string>("PayShapAccountNumber")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("varchar(256)");

                    b.Property<string>("PayShapReference")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("varchar(256)");

                    b.Property<string>("PaymentProofScreenshot")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("ProcessZero.Domain.Entities.UserSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("LastConsumptionProcessedUtc")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime?>("LastHeartbeatUtc")
                        .HasColumnType("datetime(6)");

                    b.Property<decimal>("MinutesConsumed")
                        .HasColumnType("decimal(65,30)");
            ...
            modelBuilder.Entity("ProcessZero.Domain.Entities.AgencyActivity", b =>
                {
                    b.HasOne("ProcessZero.Domain.Entities.AgencyProfile", "AgencyProfile")
                        .WithMany()
                        .HasForeignKey("AgencyProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProcessZero.Domain.Entities.AgencyContact", "Contact")
                        .WithMany("Activities")
                        .HasForeignKey("ContactId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ProcessZero.Domain.Entities.AgencyDeal", "Deal")
                        .WithMany("Activities")
